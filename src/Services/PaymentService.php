...
class PaymentService
{
    ...
    public function executePayment($requestData, $callbackfailure = false)
    {
	    ...
	    $this->sessionStorage->getPlugin()->setValue($customerComments, '');
            $transactionComments = $customerComments . '</br>' . $this->getTransactionComments($requestData);
	    $this->getLogger(__METHOD__)->error('transactioncomments', $transactionComments);
